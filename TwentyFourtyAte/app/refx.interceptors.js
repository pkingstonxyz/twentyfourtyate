...
var vec__27224_27285 = clojure.data.diff(orig_db,new_db);
var only_before_27286 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27224_27285,(0),null);
var only_after_27287 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27224_27285,(1),null);
var db_changed_QMARK__27288 = (((!((only_before_27286 == null)))) || ((!((only_after_27287 == null)))));
if(db_changed_QMARK__27288){
refx.log.info.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only before:",only_before_27286], 0));

refx.log.info.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["only after :",only_after_27287], 0));
} else {
...
var vec__27241 = refx.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"event","event",301435442));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27241,(0),null);
var payload = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27241,(1),null);
var event = vec__27241;
...
var len__5769__auto___27289 = arguments.length;
var i__5770__auto___27290 = (0);
while(true){
if((i__5770__auto___27290 < len__5769__auto___27289)){
args__5775__auto__.push((arguments[i__5770__auto___27290]));

var G__27291 = (i__5770__auto___27290 + (1));
i__5770__auto___27290 = G__27291;
continue;
} else {
}
break;
...
/** @this {Function} */
(refx.interceptors.path.cljs$lang$applyTo = (function (seq27252){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27252));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___27292 = arguments.length;
var i__5770__auto___27293 = (0);
while(true){
if((i__5770__auto___27293 < len__5769__auto___27292)){
args__5775__auto__.push((arguments[i__5770__auto___27293]));

var G__27294 = (i__5770__auto___27293 + (1));
i__5770__auto___27293 = G__27294;
continue;
} else {
}
break;
...
var new_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27275_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__27275_SHARP_);
}),in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27276_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__27276_SHARP_);
}),in_paths);
...
/** @this {Function} */
(refx.interceptors.on_changes.cljs$lang$applyTo = (function (seq27277){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(context,new cljs.core.Keyword(null,"queue","queue",1455835879),(function (p1__27284_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(refx.interceptors.global_interceptors),p1__27284_SHARP_);
}));
})], 0));
