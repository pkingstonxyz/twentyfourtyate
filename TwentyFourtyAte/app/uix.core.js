 ...
 */
uix.core.create_class = (function uix$core$create_class(p__31805){
var map__31806 = p__31805;
var map__31806__$1 = cljs.core.__destructure_map(map__31806);
var fields = map__31806__$1;
var contextType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"contextType","contextType",1033066077));
var componentDidUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",-1983477981));
var componentDidCatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"componentDidCatch","componentDidCatch",821717733));
var displayName = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"displayName","displayName",-809144601));
var childContextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"childContextTypes","childContextTypes",578717991));
var getSnapshotBeforeUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"getSnapshotBeforeUpdate","getSnapshotBeforeUpdate",861122184));
var contextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"contextTypes","contextTypes",-2023853910));
var getDerivedStateFromProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"getDerivedStateFromProps","getDerivedStateFromProps",-991834739));
var getDerivedStateFromError = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"getDerivedStateFromError","getDerivedStateFromError",166658477));
var componentWillUnmount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",1573788814));
var shouldComponentUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",1795750960));
var render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"render","render",-1408033454));
var defaultProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"defaultProps","defaultProps",-533483149));
var getInitialState = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"getInitialState","getInitialState",1541760916));
var constructor$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"constructor","constructor",-1953928811));
var componentDidMount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31806__$1,new cljs.core.Keyword(null,"componentDidMount","componentDidMount",955710936));
...
var G__31840 = props.argv;
if(cljs.core.truth_(props.children)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31840,new cljs.core.Keyword(null,"children","children",-940561982),props.children);
} else {
return G__31840;
}
});
...
if((ref.current == null)){
(ref.current = (function (){var x31911 = ({"current": value});
(x31911.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x31911.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x31911.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x31911.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return (this$__$1.current = v);
}));

(x31911.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x31911.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__31912 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__31912) : f.call(null,G__31912));
})());
}));

(x31911.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__31913 = this$__$1.current;
var G__31914 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__31913,G__31914) : f.call(null,G__31913,G__31914));
})());
}));

(x31911.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__31918 = this$__$1.current;
var G__31919 = a;
var G__31920 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__31918,G__31919,G__31920) : f.call(null,G__31918,G__31919,G__31920));
})());
}));

(x31911.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
...
var G__31967 = ({"argv": cljs_bean.core.bean.cljs$core$IFn$_invoke$arity$1(p1__31964_SHARP_)});
 ...
 */
uix.core.create_error_boundary = (function uix$core$create_error_boundary(p__32007,render_fn){
var map__32011 = p__32007;
var map__32011__$1 = cljs.core.__destructure_map(map__32011);
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__32011__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143),cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1("uix.error-boundary")));
var derive_error_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32011__$1,new cljs.core.Keyword(null,"derive-error-state","derive-error-state",-1373095498));
var did_catch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32011__$1,new cljs.core.Keyword(null,"did-catch","did-catch",2139522313));
...
var G__32014 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state.argv,set_state], null);
var G__32015 = uix.core.glue_args(props);
return (render_fn.cljs$core$IFn$_invoke$arity$2 ? render_fn.cljs$core$IFn$_invoke$arity$2(G__32014,G__32015) : render_fn.call(null,G__32014,G__32015));
});
...
var argv = (function (){var G__32032 = props.argv;
var G__32032__$1 = (cljs.core.truth_(props.children)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32032,new cljs.core.Keyword(null,"children","children",-940561982),props.children):G__32032);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__32032__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),ref);
