...
var i_14197 = (self__.level + (1));
while(true){
if((i_14197 <= (new_level + (1)))){
(update[i_14197] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14199 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14199[i]));
} else {
x__$2.forward.push((((i < links_14199.length))?(links_14199[i]):null));
}

if((i < links_14199.length)){
(links_14199[i] = x__$2);
} else {
links_14199.push(x__$2);
}
...
var i_14202 = (0);
while(true){
if((i_14202 <= self__.level)){
var links_14204 = (update[i_14202]).forward;
if((x__$1 === (((i_14202 < links_14204.length))?(links_14204[i_14202]):null))){
(links_14204[i_14202] = (x__$1.forward[i_14202]));

var G__14205 = (i_14202 + (1));
i_14202 = G__14205;
continue;
} else {
